...
for (i in 2:(draws+burnin+1)) { #
  ...
  Bn = solve(1/sigma2 * t(X_star) %*% X_star + 1/sigma2*B0_inv)
  bn = Bn %*% (1/sigma2 * t(X_star)%*%y_star + 1/sigma2*B0_inv %*% b0)
  
  ## bn/Bn == Bn_test/bn_test, check!
  ## block draw betas:
  res[i,1:p] <- mvtnorm::rmvnorm(1, bn, Bn)
  ...
  # z_star_temp = solve(1/P0 + 1/sigma2 * t(u_L1) %*% u_L1)
  # p_star_temp = solve(1/P0 + 1/sigma2 * t(u_L1) %*% u_L1) %*% (1/P0 * p0 + 1/sigma2 * t(u_L1) %*% u[-1])
  
  z_star = solve(1/sigma2 * t(u_L1) %*% u_L1 + 1/sigma2*1/P0)
  p_star = z_star %*% (1/sigma2 * t(u_L1) %*% u[-1] + 1/sigma2 * 1/P0 * p0)
