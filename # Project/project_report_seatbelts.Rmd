...
gibbs_corr_err <- function(y, X, B0_diag = 10^2, b0_mu = 0, c0 = 0.1, C0 = 0.1, p0 = 0, P0 = 1) {
  ...
  for (i in 2:(draws+burnin+1)) {
    ...
    z_star = solve(1/sigma2 * t(u_L1) %*% u_L1 + 1/P0)
    p_star = z_star %*% (1/sigma2 * t(u_L1) %*% u[-1] + 1/P0 * p0)
...
How would this model look like in Stan?
